 ...
 */
bool Viewport::IsInViewport(const Vec2& position, float radius)
{
 ...
 */
void Viewport::TrackPosition(Vec2& position, float percent)
{
   ...
   float leftEdge = MathUtilities::LinearTween(percent, vBotLeft.x, vTopRight.x);
   float rightEdge = MathUtilities::LinearTween(1-percent, vBotLeft.x, vTopRight.x);
   float topEdge = MathUtilities::LinearTween(1-percent, vBotLeft.y, vTopRight.y);
   float botEdge = MathUtilities::LinearTween(percent, vBotLeft.y, vTopRight.y);
